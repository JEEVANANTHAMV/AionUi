...
vi.mock('@/renderer/pages/conversation/platforms/forjinnrs/ForjinnrsModelSelector', () => ({
  default: () => null,
}));

vi.mock('@/renderer/pages/conversation/platforms/forjinnrs/useForjinnrsModelSelection', () => ({
  useForjinnrsModelSelection: () => ({}),
}));
