/**
 * GAP-5: ForjinnrsManager CronBusyGuard — Black-box tests
 *
 * Tests based on GAP-5-plan.md acceptance criteria.
 * Validates that ForjinnrsManager integrates cronBusyGuard to prevent
...
describe('GAP-5: ForjinnrsManager CronBusyGuard', () => {
