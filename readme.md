...
[Why Choose Forjinn-Desk?](#-why-choose-forjinn-desk-over-claude-cowork) ·
...
Forjinn-Desk ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **Forjinn-Desk works the moment you install it**.
...
> Morph-animated slide-to-slide transitions with coherent story pacing; powered by [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
> Paper/thesis writing and production-ready document editing via the `docx` skill; powered by [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
> Generate/refresh spreadsheets with `xlsx` for analysis, auto-formatting, and charts; powered by [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
If you already use Claude Code, Codex, or Qwen Code, Forjinn-Desk auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Forjinn CLI (forjinnrs, the Rust-based backend service bundled with Forjinn-Desk) • Snow CLI • Kiro • Hermes Agent • Cursor Agent and more
...
- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model via ACP (Agent Communication Protocol, Forjinn-Desk's multi-agent coordination layer), Gemini, or Forjinnrs
- **Leader orchestration** — Leader assigns, tracks, and aggregates results; supported backends include Claude Code, Codex, Gemini, Snow CLI, and Forjinn CLI
...
- **Supported backends** — Claude Code, Codex, Gemini, Snow CLI, Forjinn CLI (forjinnrs); other ACP backends with `mcpCapabilities.stdio` are auto-supported
...
Forjinn-Desk also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with Forjinn-Desk), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
Forjinn-Desk supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
Forjinn-Desk includes **20 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with Forjinn-Desk), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access Forjinn-Desk from any device, anywhere._
...
> **Setup:** Forjinn-Desk Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/Forjinn/Forjinn-Desk/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — Forjinn-Desk automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
> [Image generation model configuration guide](https://github.com/Forjinn/Forjinn-Desk/wiki/Forjinn-Desk-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose Forjinn-Desk Over Claude Cowork?
...
A: <strong>No.</strong> Forjinn-Desk has a built-in AI agent that works immediately after installation. Just sign in with Google or enter any API key. If you also have CLI tools like Claude Code or Gemini CLI installed, Forjinn-Desk will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with Forjinn-Desk?</strong></summary>
A: Forjinn-Desk is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: Forjinn-Desk is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run Forjinn-Desk on a server (headless)?</strong></summary>
A: Yes — Forjinn-Desk WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
## See How People Use Forjinn-Desk
...
> **Made a video about Forjinn-Desk?** [Let us know on X](https://x.com/Forjinn-Desk) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/Forjinn/Forjinn-Desk/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/Forjinn/Forjinn-Desk/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/Forjinn/Forjinn-Desk/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/Forjinn/Forjinn-Desk/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/Forjinn/Forjinn-Desk/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/Forjinn/Forjinn-Desk/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/Forjinn/Forjinn-Desk/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/Forjinn/Forjinn-Desk/wiki/Forjinn-Desk-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/Forjinn/Forjinn-Desk/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/Forjinn/Forjinn-Desk/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/Forjinn/Forjinn-Desk/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/Forjinn/Forjinn-Desk/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/Forjinn/Forjinn-Desk/issues) — bugs and feature requests
- [Release Updates](https://github.com/Forjinn/Forjinn-Desk/releases) — get the latest version
...
[Report Bug](https://github.com/Forjinn/Forjinn-Desk/issues) · [Request Feature](https://github.com/Forjinn/Forjinn-Desk/issues)
