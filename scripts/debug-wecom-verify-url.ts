 ...
 * Use while Forjinn-Desk WebUI is running and the WeCom channel plugin is enabled.
 *
 * Usage:
 ...
 *
 * Then curl the printed URL; response body should equal the plaintext (default: forjinn-desk-wecom-verify-ok).
 */
...
function main(): void {
  ...
  const aes = args.aes || '';
  const plain = args.plain || 'forjinn-desk-wecom-verify-ok';
