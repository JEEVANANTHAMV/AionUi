...
for f in Forjinn-Desk-1.0.0-win-x64.exe Forjinn-Desk-1.0.0-win-arm64.exe Forjinn-Desk-1.0.0-mac-x64.dmg Forjinn-Desk-1.0.0-mac-arm64.dmg Forjinn-Desk-1.0.0.deb Forjinn-Desk-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
