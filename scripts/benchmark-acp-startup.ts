...
function getLogFilePath(): string {
  ...
  // Dev mode uses "Forjinn-Desk-Dev", production uses "Forjinn-Desk"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'Forjinn-Desk-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'Forjinn-Desk', `${today}.log`);
