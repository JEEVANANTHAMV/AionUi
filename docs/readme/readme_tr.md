...
[🤔 Neden Forjinn-Desk'yi Seçmelisiniz?](#-neden-forjinn-desk-claude-cowork-yerine) ·
...
**Forjinn-Desk sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **Forjinn-Desk (Cowork)**                                                                                                                   |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
...
Forjinn-Desk tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **Forjinn-Desk kurduğunuz anda çalışır**.
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **Forjinn-Desk size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. Forjinn-Desk bulut hizmetleri ve yerel dağıtımlar dahil **20+ AI platformunu** destekler.
...
Forjinn-Desk ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (Forjinn-Desk ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
Forjinn-Desk önceden tanımlanmış yeteneklere sahip **20 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — Forjinn-Desk'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** Forjinn-Desk Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/Forjinn/Forjinn-Desk/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — Forjinn-Desk görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/Forjinn/Forjinn-Desk/wiki/Forjinn-Desk-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden Forjinn-Desk, Claude Cowork Yerine?
...
Forjinn-Desk **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, Forjinn-Desk tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | Forjinn-Desk                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> Forjinn-Desk kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Sadece Google ile giriş yapın veya herhangi bir API anahtarı girin. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, Forjinn-Desk bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: Forjinn-Desk ile ne yapabilirim?</strong></summary>
C: Forjinn-Desk sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: Forjinn-Desk tamamen ücretsiz ve açık kaynaklıdır. Gemini'yi ücretsiz kullanmak için Google ile giriş yapabilir veya tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların Forjinn-Desk'yi Nasıl Kullandığını Görün
...
> **Forjinn-Desk hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/Forjinn-Desk) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/Forjinn/Forjinn-Desk/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/Forjinn/Forjinn-Desk/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/Forjinn/Forjinn-Desk/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/Forjinn/Forjinn-Desk/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/Forjinn/Forjinn-Desk/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/Forjinn/Forjinn-Desk/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/Forjinn/Forjinn-Desk/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/Forjinn/Forjinn-Desk/wiki/Forjinn-Desk-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/Forjinn/Forjinn-Desk/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/Forjinn/Forjinn-Desk/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/Forjinn/Forjinn-Desk/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/Forjinn/Forjinn-Desk/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/Forjinn/Forjinn-Desk/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/Forjinn/Forjinn-Desk/releases) — en son sürümü alın
...
[Hata Bildir](https://github.com/Forjinn/Forjinn-Desk/issues) · [Özellik İste](https://github.com/Forjinn/Forjinn-Desk/issues)
