<p align="center">
  <img src="../../resources/forjinn-desk-banner-1.png" alt="Forjinn-Desk - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/Forjinn/Forjinn-Desk?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://www.forjinn-desk.com" target="_blank">Офіційний сайт</a>
</p>
...
[🤔 Чому варто обрати Forjinn-Desk?](#-чому-варто-обрати-forjinn-desk-замість-claude-cowork) ·
...
**Forjinn-Desk — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **Forjinn-Desk (Cowork)**                                                                                                  |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------- |
...
Forjinn-Desk постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **Forjinn-Desk працює одразу після встановлення**.
...
Ці напрямки відповідають реальним можливостям додатка: пресети **Morph PPT** та навички **`pptx` / `docx` / `xlsx`** (див. пресети `assistant/` та `skills/` у репозиторії). Потрібні документи чи таблиці? Вбудований **[OfficeCLI](https://github.com/Forjinn/OfficeCli)** допомагає створювати PPT (Morph), Word (`.docx`) та Excel (`.xlsx/.xlsm/.csv`) швидше та надійніше.

#### **Асистент PPT**

> **Результат:** редагований Morph PPT (`.pptx`)
> Плавні переходи між слайдами з анімацією Morph та цілісним сюжетом; працює на базі [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
> Написання статей/дисертацій та редагування документів через навичку `docx`; працює на базі [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
> Генерація та оновлення таблиць через `xlsx` для аналізу, автоформатування та графіків; працює на базі [OfficeCLI](https://github.com/Forjinn/OfficeCli).
...
Якщо ви вже використовуєте Claude Code, Codex або Qwen Code, Forjinn-Desk автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Forjinn CLI (forjinnrs, Rust-бекенд-сервіс у складі Forjinn-Desk) • Snow CLI • Kiro • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності Forjinn-Desk), Gemini або Forjinnrs
- **Оркестрація Leader** — Leader призначає, відстежує та агрегує результати; підтримувані бекенди: Claude Code, Codex, Gemini, Snow CLI, Forjinn CLI
...
- **Підтримувані бекенди** — Claude Code, Codex, Gemini, Snow CLI, Forjinn CLI (forjinnrs); інші ACP-бекенди з `mcpCapabilities.stdio` підтримуються автоматично
...
Інші додатки дають лише вікно чату. **Forjinn-Desk дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. Forjinn-Desk підтримує **20+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з Forjinn-Desk), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з Forjinn-Desk), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим без сну** — Forjinn-Desk автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/forjinn-desk sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати Forjinn-Desk замість Claude Cowork?

Forjinn-Desk — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, Forjinn-Desk — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/Forjinn/Forjinn-Desk/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/Forjinn/Forjinn-Desk/issues) — баги та запити функцій
