...
> PR：[#1991](https://github.com/Forjinn/Forjinn-Desk/pull/1991) (问题 1-3)
> Issue：[#1990](https://github.com/Forjinn/Forjinn-Desk/issues/1990)
...
JSON 文件 KV 存储，每个扩展一个文件 `~/.forjinn-desk/extension-storage/{name}.json`：
