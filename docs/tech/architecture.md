...
Forjinn-Desk is an Electron app with three types of processes:
...
Forjinn-Desk can run in four modes. The WebSocket channel is the browser-side equivalent of
