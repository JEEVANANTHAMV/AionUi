...
/**
 * Forjinn-Desk应用程序共用常量
 */

// ===== 文件处理相关常量 =====

/** 临时文件时间戳分隔符 */
export const FORJINN_DESK_TIMESTAMP_SEPARATOR = '_forjinn_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const FORJINN_DESK_TIMESTAMP_REGEX = /_forjinn_\d{13}(\.\w+)?$/;
export const FORJINN_DESK_FILES_MARKER = '[[FORJINN_FILES]]';
...
export const WEBUI_DEFAULT_PORT = (() => {
  ...
  if (process.env.FORJINN_DESK_MULTI_INSTANCE === '1') return 25810;
  return 25809;
})();
