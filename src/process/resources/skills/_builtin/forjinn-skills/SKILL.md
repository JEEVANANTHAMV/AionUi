...
description: 'Access the Forjinn Skills registry — discover and download AI agent skills. Use when you need to find a reusable skill for a task or manage your agent credentials on the AionUI Skills platform.'
---
...
**Homepage**: https://skills.forjinn-desk.com
...
Read `~/.config/forjinn-desk-skills/SKILL.md` and follow the **Registration** section
