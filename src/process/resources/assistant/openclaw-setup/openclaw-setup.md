...
**Option B: Start Forjinn-Desk WebUI Remote Mode**

- **Experience**: Access through browser with Forjinn-Desk's full interface features
...
- **Configuration requirements**: Start Forjinn-Desk WebUI service, access through browser
...
5. **Post-installation configuration guidance** (IMPORTANT):
   ...
   - **Usage guidance**:
     - **Local usage**: "After OpenClaw installation is complete, **please restart Forjinn-Desk**, then you can see OpenClaw in the available Agent list on the Forjinn-Desk homepage and start chatting directly."
...
1. **Ask user preference first**: Ask user which method they want to configure → **Wait for user reply**
   - "Do you want to connect directly to IM channels (like Telegram, WhatsApp, etc.), or use Forjinn-Desk WebUI remote mode?"
...
4. **Option B: Start Forjinn-Desk WebUI Remote Mode**
   - **Must use forjinn-desk-webui-setup skill**: Consult `references/forjinn-desk-webui.md`
   - **Workflow**:
     1. Ask user needs: Same WiFi, cross-network access, or server deployment? → **Wait for user reply**
     2. After user replies, **guide user to Forjinn-Desk settings interface**:
        - **Open settings interface**: Clearly tell user how to open it
          - "Please click the **Settings icon** (gear icon) at the bottom left of Forjinn-Desk"
          - "In the settings menu, click the **'WebUI'** option"
          - "Enter the WebUI configuration interface"
        - **Configuration steps**: Follow `forjinn-desk-webui-setup` skill's `references/forjinn-desk-webui.md` documentation to guide user:
   ...
   - **Key principles**:
     ...
     - **Don't attempt to install `@forjinn-desk/webui` or similar npm packages**: WebUI is a built-in feature of Forjinn-Desk, not a separate package
...
### forjinn-desk-webui-setup Skill

**Core documentation**: `references/forjinn-desk-webui.md`

**When to use**: When user chooses WebUI option, use immediately

**How to use**:

1. **Directly consult `references/forjinn-desk-webui.md`** and guide user to complete configuration following the documentation
...
5. **Post-installation configuration guidance**:
   ...
   - **Usage guidance**:
     - Introduce local usage (return to Forjinn-Desk homepage)
...
3. **Choose WebUI**: Use `forjinn-desk-webui-setup` skill → Ask needs → Choose solution → Execute configuration → Provide usage instructions
...
7. **Skill usage**:
   ...
   - WebUI configuration → **Must use `forjinn-desk-webui-setup` skill** (directly consult `references/forjinn-desk-webui.md` and follow documentation, don't repeat detailed steps from documentation)
