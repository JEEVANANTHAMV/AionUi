...
> После появления файла таблицы в рабочей области вы можете просмотреть его прямо в Forjinn-Desk. Однако, пожалуйста, не нажимайте «Открыть в системном приложении», так как это может заблокировать файл и привести к сбою генерации.
