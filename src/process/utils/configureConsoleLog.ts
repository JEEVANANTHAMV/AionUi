 ...
 *   - macOS:   ~/Library/Logs/Forjinn-Desk/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\Forjinn-Desk\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/Forjinn-Desk/logs/YYYY-MM-DD.log
 *
