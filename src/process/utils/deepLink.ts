...
export const PROTOCOL_SCHEME = 'forjinn';

/**
 * Parse an forjinn:// URL into action and params.
 * Supports two formats:
 *   1. forjinn://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. forjinn://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
