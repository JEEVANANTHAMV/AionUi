...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'Forjinn-Desk Assistant',
    text: '### Forjinn-Desk Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with Forjinn-Desk:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open Forjinn-Desk settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in Forjinn-Desk settings:',
      '1. Open Forjinn-Desk app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'Forjinn-Desk Assistant Help',
    text: [
      '### Forjinn-Desk Assistant Help',
      '',
      'A remote assistant to interact with Forjinn-Desk via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in Forjinn-Desk settings',
...
export function createSettingsCard(): DingTalkCard {
  return {
    ...
    text: [
      '### Settings',
      '',
      'Channel settings need to be configured in the Forjinn-Desk app.',
      '',
      'Open Forjinn-Desk > WebUI > Channels',
    ].join('\n'),
