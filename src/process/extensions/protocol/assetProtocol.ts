 ...
 * The forjinn-asset:// protocol serves local files through Electron's net module,
 * bypassing this restriction.
 *
 * URL format: forjinn-asset://asset/C:/path/to/file.svg
 ...
 */
export const FORJINN_ASSET_PROTOCOL = 'forjinn-asset';

/** Fixed hostname used in forjinn-asset:// URLs. */
export const FORJINN_ASSET_HOST = 'asset';

/**
 * Convert an absolute file path to an forjinn-asset:// URL.
...
export function toAssetUrl(absPath: string): string {
  ...
  return `${FORJINN_ASSET_PROTOCOL}://${FORJINN_ASSET_HOST}/${normalized}`;
}
