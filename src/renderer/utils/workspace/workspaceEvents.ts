export const WORKSPACE_TOGGLE_EVENT = 'forjinn-desk-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'forjinn-desk-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'forjinn-desk-workspace-has-files';
