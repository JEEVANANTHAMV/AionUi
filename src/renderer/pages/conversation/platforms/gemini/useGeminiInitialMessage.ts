  ...
  useEffect(() => {
    ...
    const sendInitialMessage = async () => {
      try {
        ...
        console.log(`[GeminiInitialMessage] Sending initial message to backend: ${conversationId}, msg_id: ${msg_id}`);
        ...
        console.log(`[GeminiInitialMessage] sendMessage result:`, result);
