...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'forjinn-desk_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'forjinn-desk:workspace-expansion-changed';
