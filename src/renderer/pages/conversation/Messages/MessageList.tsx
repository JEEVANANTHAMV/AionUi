    ...
    return (
      <div
        ...
        className={classNames(
          'min-w-0 flex items-start message-item [&>div]:max-w-full px-8px m-t-10px max-w-full mx-auto',
          message.type,
          {
    ...
    if ('type' in item && ['file_summary', 'tool_summary'].includes(item.type)) {
      return (
        <div
          ...
          className={'min-w-0 message-item px-8px m-t-10px max-w-full mx-auto ' + item.type}
          style={highlighted ? highlightStyle : undefined}
        >
