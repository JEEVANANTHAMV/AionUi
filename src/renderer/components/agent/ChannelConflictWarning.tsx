...
/**
 * Warning component when OpenClaw channel conflicts with Forjinn-Desk Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not Forjinn-Desk.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in Forjinn-Desk will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use Forjinn-Desk Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and Forjinn-Desk.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for Forjinn-Desk.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in Forjinn-Desk Channels and continue using OpenClaw's integration.
          </Paragraph>
