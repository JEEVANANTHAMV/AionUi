...
const AboutModalContent: React.FC = () => {
  ...
  const checkUpdate = () => {
    ...
    window.dispatchEvent(new CustomEvent('forjinn-desk-open-update-modal', { detail: { source: 'about' } }));
  };

  const linkItems: LinkItem[] = [
    {
      title: t('settings.helpDocumentation'),
      url: 'https://github.com/iOfficeAI/Forjinn-Desk/wiki',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/iOfficeAI/Forjinn-Desk/releases',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.feedback'),
      url: 'https://github.com/iOfficeAI/Forjinn-Desk/issues',
      icon: <Right theme='outline' size='16' />,
    },
    {
    ...
    },
    {
      ...
      url: 'https://www.forjinn-desk.com',
      icon: <Right theme='outline' size='16' />,
    },
  ];
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/iOfficeAI/Forjinn-Desk').catch((error) =>
