...
const UpdateModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('forjinn-desk-open-update-modal', handleOpenUpdateModal);

    return () => {
      removeOpenListener();
      window.removeEventListener('forjinn-desk-open-update-modal', handleOpenUpdateModal);
    };
  }, []);
