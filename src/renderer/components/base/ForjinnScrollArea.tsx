 ...
 * <ForjinnScrollArea className="h-400px">
 *   <div>Content...</div>
 * </ForjinnScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <ForjinnScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </ForjinnScrollArea>
 *
 * // 双向滚动 / Both directions
 * <ForjinnScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </ForjinnScrollArea>
 * ```
 */
interface ForjinnScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const ForjinnScrollArea: React.FC<ForjinnScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
ForjinnScrollArea.displayName = 'ForjinnScrollArea';

export default ForjinnScrollArea;
