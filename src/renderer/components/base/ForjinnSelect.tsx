...
type ForjinnSelectSize = NativeSelectSize | 'middle';

export interface ForjinnSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: ForjinnSelectSize;
}

/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .forjinn-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .forjinn-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <ForjinnSelect placeholder="请选择" style={{ width: 200 }}>
 *   <ForjinnSelect.Option value="1">选项1</ForjinnSelect.Option>
 *   <ForjinnSelect.Option value="2">选项2</ForjinnSelect.Option>
 * </ForjinnSelect>
 *
 * // 多选 / Multiple selection
 * <ForjinnSelect mode="multiple" placeholder="请选择多个">
 *   <ForjinnSelect.Option value="1">选项1</ForjinnSelect.Option>
 *   <ForjinnSelect.Option value="2">选项2</ForjinnSelect.Option>
 * </ForjinnSelect>
 *
 * // 分组 / Grouped options
 * <ForjinnSelect placeholder="请选择">
 *   <ForjinnSelect.OptGroup label="分组1">
 *     <ForjinnSelect.Option value="1">选项1</ForjinnSelect.Option>
 *   </ForjinnSelect.OptGroup>
 *   <ForjinnSelect.OptGroup label="分组2">
 *     <ForjinnSelect.Option value="2">选项2</ForjinnSelect.Option>
 *   </ForjinnSelect.OptGroup>
 * </ForjinnSelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.forjinn-select)
 */
const mapSizeToNative = (size?: ForjinnSelectSize): NativeSelectSize | undefined => {
...
const InternalSelect = React.forwardRef<SelectHandle, ForjinnSelectProps>(
...
const ForjinnSelect = InternalSelect as ForjinnSelectComponent;

ForjinnSelect.displayName = 'ForjinnSelect';

// 导出子组件 / Export sub-components
ForjinnSelect.Option = Select.Option;
ForjinnSelect.OptGroup = Select.OptGroup;

export default ForjinnSelect;
