 ...
 */
export interface ForjinnCollapseProps {
 ...
 */
export interface ForjinnCollapseItemProps {
 ...
 */
const ForjinnCollapseItem: React.FC<ForjinnCollapseItemProps> = ({ children }) => <>{children}</>;
ForjinnCollapseItem.displayName = 'ForjinnCollapseItem';
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <ForjinnCollapse defaultActiveKey={['1']}>
 *   <ForjinnCollapse.Item name="1" header="面板1">
 *     内容1
 *   </ForjinnCollapse.Item>
 *   <ForjinnCollapse.Item name="2" header="面板2">
 *     内容2
 *   </ForjinnCollapse.Item>
 * </ForjinnCollapse>
 *
 * // 手风琴模式 / Accordion mode
 * <ForjinnCollapse accordion defaultActiveKey="1">
 *   <ForjinnCollapse.Item name="1" header="面板1">内容1</ForjinnCollapse.Item>
 *   <ForjinnCollapse.Item name="2" header="面板2">内容2</ForjinnCollapse.Item>
 * </ForjinnCollapse>
 *
 * // 自定义图标 / Custom icon
 * <ForjinnCollapse
 ...
 * ```
 */
const ForjinnCollapseComponent: React.FC<ForjinnCollapseProps> & { Item: typeof ForjinnCollapseItem } = ({
  children,
  className,
  defaultActiveKey,
  activeKey,
  ...
  const items = useMemo(() => {
    return React.Children.toArray(children).filter((child): child is React.ReactElement<ForjinnCollapseItemProps> => {
      return React.isValidElement(child) && child.type === ForjinnCollapseItem;
    });
  }, [children]);
...
ForjinnCollapseComponent.Item = ForjinnCollapseItem;

export default ForjinnCollapseComponent;
