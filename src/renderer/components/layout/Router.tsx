...
const ForjinnrsSettings = React.lazy(() => import('@renderer/pages/settings/ForjinnrsSettings'));
...
const AttachedAgentsSettings = React.lazy(() => import('@renderer/pages/settings/AttachedAgentsSettings'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/forjinnrs' element={withRouteFallback(ForjinnrsSettings)} />
          <Route
            path='/team/:id'
          ...
          <Route path='/settings/attached-agents' element={withRouteFallback(AttachedAgentsSettings)} />
